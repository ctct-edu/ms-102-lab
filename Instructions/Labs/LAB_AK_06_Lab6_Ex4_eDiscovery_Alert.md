...
6. [名前]には[2025_内部調査_経理部_不正会計]と入力し、[作成]をクリックします。
...
10. [不正会計データ]画面を一番下までスクロールします。[条件ビルダー] の [キーワード]に[売上帳]と入力します。

    ![](./media/lab6-26.png)

11. [不正会計データ]画面を一番上までスクロールして戻り、[クエリの実行] [Run Query]とクリックします。
