...
4. 画面の右側に表示されるメッセージ ペインに、次の情報を入力した後、**[送信] **を選択します.。
...
10. 別のブラウザーを開くか、Hollyをサインアウトして、Teams (https://teams.cloud.microsoft)にLynne Robbinsとしてサインインします。これまで送ったメッセージが届いていることを確認してください。
