...
### (オプション) タスク 2 – Office のグローバル ダウンロード設定が Microsoft 365 Apps for enterprise のインストールにどのような影響を与えるかを確認する
...
9. Microsoft 365 ポータル (Laura の Microsoft 365 ホーム ページ)の左メニューの **[アプリ] - [その他のアプリ]** を選択します。![](./media/lab2-3-2.png)

10. 画面右上に表示されるドロップダウン メニューで **[アプリをインストール] - [Microsoft 365 Apps]** を選択します。これにより、Laura の[マイ アカウント]ウィンドウが開きます。

   ![](./media/lab2-3-4.png)

11. Laura の[マイ アカウント] ウィンドウの **[アプリとデバイスを表示]**  を選択します。

12. [アプリとデバイス]ウィンドウの[Office]セクションの下に、「office のインストールは、管理者によって無効にされています。組織内での office の入手方法の詳細については、管理者にお問い合わせください。」というメッセージが表示されます。
...
18. [アプリとデバイス] 画面に [Office のインストール] ボタンが表示されます 。（表示されない場合は、再サインイン等お試しください）![](./media/lab2-3-3.png)
