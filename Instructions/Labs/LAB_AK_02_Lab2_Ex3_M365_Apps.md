...
9. Laura がサインアウトしたら、Microsoft Edge ブラウザーを閉じます。

10. 次に、Laura Atkins として LON-CL2 からログアウトし、Adatum 管理者として再度ログインします。これにより、この PC を使用する次のラボ用に LON-CL2 が準備されます。

    LON-CL2 で、VM ラボ環境で**Ctrl+Alt+Delete機能を選択します。**

11. デスクトップ メニューで、**[ユーザーの切り替え]** を選択します。

12. デスクトップでは、デフォルトで管理が選択されています。「パスワード」フィールドに**「Pa55w.rd」**　と入力してログインします。
