...
4. [秘密度ラベル] ページでは、次の内容を示す警告メッセージがページの中央に表示されているか確認してください。![image](./media/lab9-0.png)
   ...
   表示されている場合は、メッセージの右側に表示される **「今すぐ有効にする」** ボタンを選択します。メッセージが次のように変更されたことに注意してください。「Teams 、SharePoint サイト、および Microsoft 365 グループのプライバシーとアクセス制御設定を使用して秘密度ラベルを作成できるようになりました。」

   

   最初から警告メッセージが表示されていない場合は、何もせず次の手順に進んでください。
