...
5. [多要素認証を設定する必要があります] が表示された場合は **[今は行わない]** を選択し、次の画面で任意の理由を入力してすすめてください。

   （ **[今すぐ設定]** を選択して、Microsoft Authenticatorの多要素認証を設定してた場合も問題ありません。2日目の演習では必須の設定ですので、１日前倒したことになります。）
