...
20.  [アクティブなチームとグループ]ウィンドウに戻ります。 **[セキュリティ グループ]** タブを選択して、セキュリティ グループのリストを表示します。 **[+セキュリティ グループを追加]** オプションを選択します。手順 3 ～ 19の要領を繰り返して、次の情報を含む新しいグループを追加します。
...
26. ユーザーのリストで、 **Isaiah Langer 、Megan Bowen 、およびNestor Wilke のチェック ボックスをオン** にし、ペインの下部にある **[Add(3)]** ボタンを選択します。
