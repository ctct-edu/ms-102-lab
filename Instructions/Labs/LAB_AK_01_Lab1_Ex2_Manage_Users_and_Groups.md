...
22. **[セキュリティ]** タブで、**IT Admins** グループを選択します (名前の左側に表示されるチェック ボックスではなく、名前を選択します)。

23. 表示される **[IT Admins]** ペインで、 **「メンバー」** タブを選択します。
...
31. **これにより、アクティブなチームとグループ** のリストに戻ります。Inside **Salesグループは** **[Microsoft 365グループ]** タブに表示されなくなります。Inside Sales グループがまだ表示されている場合は、数分待ってから、メニュー バーの[更新]オプションを選択します。 更新されたアクティブなチームとグループの リストには、Inside Sales グループが含まれなくなります。
