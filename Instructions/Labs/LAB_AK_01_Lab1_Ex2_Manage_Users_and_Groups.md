...
10. [設定の編集]　ページで、次の情報を入力します。
    ...
    - [Microsoft Teams をグループに追加] セクションで、[このグループのチームを作成する] チェック ボックスがオフになっていることを確認し、 **[次へ]** を選択します。
...
14. 「このグループにMicrosoft Teams を追加しますか？」の右に表示される **[Teams を追加]** をクリックします。

15. さらに表示される、青い **[Teams を追加]** ボタンををクリックした後、「M365 パイロット プロジェクト」ウィンドウ右上の **[x]**  をクリックして、ウィンドウを閉じます。

16. 手順 1 ～ 15 を繰り返して、次の情報を含む新しいMicrosoft 365 グループを追加します。
