...
27. 次に、グループを削除した場合の影響をテストします。アクティブなチームとグループのリストで、**[TeamとMicrosoft 365グループ]** タブを選択します。Microsoft 365 グループのリストで、Inside Salesグループを見つけて、 **Inside Sales グループの右側に表示される垂直省略記号アイコン (その他のアクション) を選択** します。表示されるドロップダウン メニューで、**[グループの削除]** を選択します。

28. Inside Sales を削除しますか？と表示されるペインで、**[グループを削除]** ボタンを選択します。
