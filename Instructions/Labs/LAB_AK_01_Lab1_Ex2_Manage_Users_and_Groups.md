...
27. 次に、グループを削除した場合の影響をテストします。アクティブなチームとグループのリストで、**[TeamsとMicrosoft 365グループ]** タブを選択します。Microsoft 365 グループのリストで、Inside Salesグループを見つけて、 **Inside Sales グループの右側に表示される垂直省略記号アイコン (その他のアクション) を選択** します。表示されるドロップダウン メニューで、**[チームの削除]** を選択します。
