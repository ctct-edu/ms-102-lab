...
2. 左側のナビゲーション ウィンドウの [管理センター]で、 **[ID]**　を選択します。これにより、ブラウザーにEntra 管理センターの新しいタブが開きます。
3. 左側の **[Entra ID]** から **[役割と管理者]** を選択します。
4. [アクセス許可]ページには、Azure AD、電子メールとコラボレーションのロール、クラウド アプリの 3 つのセクションがあります。**[メールと共同作業の役割]** セクションで、**[役割]** を選択します。
5. 表示される役割のリストで、 **コンプライアンス データ管理者** 役割グループを選択します(誤って コンプライアンス管理者 を選択しないよう注意してください)。
6. 上の方にある **「+割り当ての追加」** ボタンを選択します。
7. **[メンバーが選択されていない]** リンクを選択します。
8. 「検索」フィールドに **「Lynne」** と入力します。名前に Lynne が含まれるユーザーのリストが表示されるので、  **Lynne Robbinsの横のチェック ボックスをオン** にして、 **[選択]** を選択します。
9. 「割り当ての追加」ウィンドウで、 **「次へ」** を選択します。
10. 「割り当ての追加」ウィンドウで、 **「割り当て」** を選択します。
