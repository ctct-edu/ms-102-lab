...
13.  **[M365 パイロット プロジェクト]** の名前をクリックします。

14. 「このグループにMicrosoft Teams を追加しますか？」の右にある **[Teams を追加]** をクリックします。![](./media/lab1-1-2.png)
...
28. [デフォルトのテーマ]ペインで、[ユーザーの表示名を表示する] オプションが選択されていないことに注目してください。ウィンドウの上部にある戻る矢印を選択して、 [組織に合わせて Microsoft 365 をカスタマイズ] ウィンドウに戻ります。[組織に合わせて Microsoft 365 をカスタマイズ]ウィンドウを閉じます。
